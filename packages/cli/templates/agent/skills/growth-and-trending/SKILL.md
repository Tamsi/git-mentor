...
4. Prefer **portfolio-building** actions over passive reading.
5. Align suggestions with **target role** (e.g. AI engineer → RAG/agent/eval repos, not random hype).
